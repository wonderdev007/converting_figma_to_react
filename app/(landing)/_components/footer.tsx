...
export function Footer() {
    return (
        <div className="p-4 smTablet:p-0 md:h-[445px] bg-primary w-full flex flex-col items-center relative">
            <div className="w-full smTablet:w-[1248px] flex flex-col items-center px-4 smTablet:px-0">
                ...
                <div className="justify-between w-full flex flex-col smTablet:flex-row gap-4 smTablet:gap-0 px-8 smTablet:px-0">
                    <div>
                        <p className="text-[20px] text-semibold text-white font-[family-name:var(--font-manrope-medium)] font-[600] mb-3 smTablet::mb-[28px]">
                            Stay Connected
                        </p>
                        <div className="flex flex-col gap-1 smTablet:gap-3">
                    ...
                    <div>
                        <p className="text-[20px] text-semibold text-white font-[family-name:var(--font-manrope-medium)] font-[600] mb-2 smTablet:mb-[28px]">
                            Our Technology Partners
                        </p>
                        <div className="flex flex-col gap-1 smTablet:gap-4">
                ...
                <div className="flex flex-col smTablet:flex-row justify-between items-start smTablet:items-end w-full px-8 smTablet:px-0">
                    <div className="flex-1">
                        <p className="text-base text-bold text-white font-[family-name:var(--font-manrope-medium)] font-[600] mb-2  mt-4 smTablet:mt-0 smTablet:mb-4">
                            Follow us
                        </p>
                    ...
                    <div className="grow mt-5 smTablet:mt-0">
            ...
            <Button
                variant={"ghost"}
                className="bg-[#03FB3A] fixed right-0 bottom-7 p-2 border rounded-tr-[15px] rounded-tl-[0px] rounded-br-[0px] rounded-bl-[20px] hover:bg-[#03FB3A]"
            >
                <Image
                    src={greenWhatsapp}
                    alt="whatsapp"
